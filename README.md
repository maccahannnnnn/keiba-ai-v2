...
- 小倉: 芝1000m、芝1200m、芝1700m、芝1800m、芝2000m、芝2600m、ダート1000m、ダート1700m、ダート2400m
- 札幌: 芝1000m、芝1200m、芝1500m、芝1800m、芝2000m、芝2600m、ダート1000m、ダート1700m、ダート2400m
- 新潟: 芝1000m、芝1200m、芝1400m、芝1600m、芝1800m、芝2000m、芝2200m、芝2400m、ダート1000m、ダート1200m、ダート1800m
- 東京: 芝1400m、芝1600m、芝1800m、芝2000m、芝2400m、芝2500m、芝3400m、ダート1300m、ダート1400m、ダート1600m、ダート2100m
- 中山: 芝1200m、芝1600m、芝1800m、芝2000m、芝2200m、芝2500m、芝3600m、ダート1200m、ダート1800m、ダート2400m
- 中京: 芝1200m、芝1400m、芝1600m、芝2000m、芝2200m、ダート1200m、ダート1400m、ダート1800m、ダート1900m
- 京都: 芝1200m、芝1400m、芝1600m、芝1800m、芝2000m、芝2200m、芝2400m、芝3000m、芝3200m、ダート1200m、ダート1400m、ダート1800m、ダート1900m
- 阪神: 芝1200m、芝1400m、芝1600m、芝1800m、芝2000m、芝2200m、芝2400m、芝2600m、芝3000m、ダート1200m、ダート1400m、ダート1800m、ダート2000m
...
### Course Knowledge: 札幌競馬場

札幌競馬場は右回りのローカル洋芝コースです。直線は短めですが、函館よりコーナーが緩く、先行力だけでなく、まくり、早め進出、洋芝適性、持続力、パワーを重視します。

札幌芝の基本方針:

- 洋芝適性、持続力、パワーを評価
- 芝1200mは先行力とスピード持続力を評価
- 芝1500mは内から中枠の立ち回り、位置取りを評価
- 芝1800m、芝2000m、芝2600mはまくり性能とロングスパートを評価
- 開催後半や雨では時計が掛かる馬場への適性を重視

札幌ダートの基本方針:

- ダート1000mはテンの速さと二の脚を最重視
- ダート1700mは逃げ、先行、まくり、パワー、持続力を評価
- ダート2400mはスタミナ、折り合い、早め進出を評価
- 後方一気型は基本的に割引

`knowledge/courses/sapporo.py` には、ペース別傾向、枠順傾向、開催時期バイアス、馬場状態別特徴、血統相性、理由付き `score_modifiers`、Explain Engine 用コメントを保存しています。

### Course Knowledge: 新潟競馬場

新潟競馬場は左回りのローカルコースです。芝は直線1000m、内回り、外回りで性格が大きく変わるため、距離ごとの個別評価を重視します。

新潟芝の基本方針:

- 芝1000mは通常の芝短距離とは別カテゴリーとして、直線競馬適性、外枠、外ラチ適性、テンの速さを評価
- 芝外回りは長い直線での瞬発力、トップスピード、末脚持続力を評価
- 芝内回りは先行力、立ち回り、持続力、ロングスパートを評価
- 開催後半は内荒れ、外差し、外伸びバイアスを確認

新潟ダートの基本方針:

- ダート1000mはテンの速さと先行力を重視
- ダート1200mはテンの速さ、先行力、スピード持続力を評価
- ダート1800mは先行力、持続力、パワー、早め進出を評価
- 後方一気型は展開の助けが必要

`knowledge/courses/niigata.py` には、ペース別傾向、枠順傾向、開催時期バイアス、馬場状態別特徴、血統相性、理由付き `score_modifiers`、Explain Engine 用コメントを保存しています。

### Course Knowledge: 東京競馬場

東京競馬場は左回りで直線が長く、瞬発力、持続力、上がり性能が問われるコースです。小回り適性よりも、長い直線で能力を出し切れるかを重視します。

東京芝の基本方針:

- 長い直線、瞬発力勝負、上がり性能を評価
- 左回り適性、直線での持続力、スローからの加速力を評価
- 東京実績と速い上がりへの対応を重視
- 開幕週や高速馬場では前残りも確認

東京ダートの基本方針:

- ダート1600mは芝スタートのワンターン戦として加速力と持続力を評価
- ダート1400mはスピードと持続力を評価
- ダート2100mはスタミナ、持続力、位置取りを評価
- 直線が長いため、単純な逃げ粘りより持続脚を評価

`knowledge/courses/tokyo.py` には、ペース別傾向、枠順傾向、開催時期バイアス、馬場状態別特徴、血統相性、理由付き `score_modifiers`、Explain Engine 用コメントを保存しています。

### Course Knowledge: 中山競馬場

中山競馬場は右回りで直線が短く、最後に急坂があるコースです。東京のような長い直線の瞬発力だけではなく、位置取り、立ち回り、持続力、坂対応を重視します。

`knowledge/courses/nakayama.py` には、芝1200m、1600m、1800m、2000m、2200m、2500m、3600m、ダート1200m、1800m、2400mの CourseProfile、ペース別傾向、枠順傾向、開催時期バイアス、馬場状態別特徴、血統相性、理由付き `score_modifiers`、Explain Engine 用コメントを保存しています。

### Course Knowledge: 中京競馬場

中京競馬場は左回りで芝もダートも直線が長く、最後に急坂があるコースです。東京のような末脚だけではなく、長い直線で脚を持続し、急坂を踏ん張れるかを重視します。

中京芝の基本方針:

- 左回り適性、持続力、急坂適性を評価
- スローでは瞬発力、平均以上では持続力を評価
- 開幕週は内前、開催後半は外差しを確認
- 時計が掛かる馬場ではパワー型を評価

中京ダートの基本方針:

- ダート1200m、1400mはスピードと持続力を評価
- ダート1800m、1900mはスタミナ、持続力、位置取りを評価
- 長い直線と急坂があるため、先行力だけでなく最後まで脚を使える能力を評価
- ハイペースでは差しの浮上も確認

`knowledge/courses/chukyo.py` には、芝1200m、1400m、1600m、2000m、2200m、ダート1200m、1400m、1800m、1900mの CourseProfile、ペース別傾向、枠順傾向、開催時期バイアス、馬場状態別特徴、血統相性、理由付き `score_modifiers`、Explain Engine 用コメントを保存しています。

### Course Knowledge: 京都競馬場

京都競馬場は右回りで、芝もダートも直線が平坦寄りです。3コーナー付近の淀の坂と、下り坂から4コーナーへ向かう加速が大きな特徴です。

京都芝の基本方針:

- 下り坂からスムーズに加速できる馬を評価
- 外回りは瞬発力、持続力、折り合いを評価
- 内回りは位置取り、機動力、4角で動ける力を評価
- 長距離では折り合い、スタミナ、ロングスパート性能を重視
- 開幕週は内前、開催後半は外差しも確認

京都ダートの基本方針:

- ダート1200m、1400mはテンの速さ、追走力、先行力を評価
- ダート1800m、1900mは先行力、位置取り、持続力、距離適性を評価
- 平坦寄りの直線でスピードを維持できる馬を評価
- 脚抜きが良い馬場では前残りを警戒

`knowledge/courses/kyoto.py` には、芝1200m、1400m、1600m、1800m、2000m、2200m、2400m、3000m、3200m、ダート1200m、1400m、1800m、1900mの CourseProfile、ペース別傾向、枠順傾向、開催時期バイアス、馬場状態別特徴、血統相性、理由付き `score_modifiers`、Explain Engine 用コメントを保存しています。

### Course Knowledge: 阪神競馬場

阪神競馬場は右回りで、芝は内回りと外回りで性格が大きく変わります。最後の直線に急坂があり、芝もダートも「坂を越えて最後まで脚を使えるか」を重視します。

阪神芝の基本方針:

- 外回りは瞬発力、上がり性能、急坂適性を評価
- 内回りは位置取り、機動力、持続力を評価
- 急坂があるため平坦専用馬は割引
- 開幕週は内前、開催後半は外差しを確認
...
- ダート1200m、1400mはテンの速さ、追走力、先行力、急坂適性を評価
- ダート1800mは位置取り、持続力、パワーを評価
- ダート2000mはスタミナ、持続力、ロングスパート性能を評価
- 乾いた馬場ではパワー型、脚抜きが良い馬場では前残りを確認

`knowledge/courses/hanshin.py` には、芝1200m、1400m、1600m、1800m、2000m、2200m、2400m、2600m、3000m、ダート1200m、1400m、1800m、2000mの CourseProfile、ペース別傾向、枠順傾向、開催時期バイアス、馬場状態別特徴、血統相性、理由付き `score_modifiers`、Explain Engine 用コメントを保存しています。
...
`knowledge/course_profiles.py` は互換性維持の入口として残し、内部で `knowledge/courses/fukushima.py`、`knowledge/courses/hakodate.py`、`knowledge/courses/kokura.py`、`knowledge/courses/sapporo.py`、`knowledge/courses/niigata.py`、`knowledge/courses/tokyo.py`、`knowledge/courses/nakayama.py`、`knowledge/courses/chukyo.py`、`knowledge/courses/kyoto.py`、`knowledge/courses/hanshin.py` を読み込みます。
今後、東京・中山・中京・京都・阪神などを追加する場合は、`knowledge/courses/tokyo.py`、`knowledge/courses/nakayama.py`、`knowledge/courses/chukyo.py`、`knowledge/courses/kyoto.py`、`knowledge/courses/hanshin.py` のように競馬場ごとに分けて追加します。
...
血統知識は `knowledge/bloodlines/` 配下で管理します。

現在は土台のみ作成済みです。Analyzer への接続や評価式への組み込みはまだ行っていません。

- `foundation.py`: 血統理論の基礎
- `sire_profiles.py`: 主要種牡馬
- `broodmare.py`: 母父・母系
- `nicks.py`: ニックス・クロス・配合理論
- `turf.py`: 芝血統
- `dirt.py`: ダート血統
- `stamina.py`: スタミナ・長距離血統
- `speed.py`: スピード・短距離血統
- `course_affinity.py`: コース別血統相性

既存Analyzerとの互換性を保つため、従来の `knowledge/bloodlines/profiles.py` も残しています。
